...
public final class zzfr implements zzgm {
    ...
    private static final void zzR(zzgl zzgl) {
        if (zzgl == null) {
            ...
            throw new IllegalStateException("Component not initialized: ".concat(String.valueOf(String.valueOf(zzgl.getClass()))));
        }
    }
                    ...
                    if (queryIntentActivities != null && !queryIntentActivities.isEmpty()) {
                        ...
                        if (!TextUtils.isEmpty(optString)) {
                            try {
                                ...
                                zzv3.zzt.zzay().zzd().zzb("Failed to persist Deferred Deep Link. exception", e);
                                return;
                            }
                        } else {
                            return;
    ...
    public final void zzE() {
        ...
        zzlb zzv2 = zzv();
        zzh().zzt.zzk.zzh();
        URL zzE2 = zzv2.zzE(74029, zzl2, (String) zzb2.first, -1 + zzm().zzo.zza());
        if (zzE2 != null) {
            zzib zzr3 = zzr();
