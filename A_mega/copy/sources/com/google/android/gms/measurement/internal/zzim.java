...
public final class zzim extends zzf {
    ...
    /* access modifiers changed from: private */
    public final void zzA(zzie zzie, zzie zzie2, long j, boolean z, Bundle bundle) {
        String str;
        long j2;
        long j3;
        zzie zzie3 = zzie;
        ...
        zzg();
        boolean z2 = false;
        boolean z3 = zzie4 == null || zzie4.zzc != zzie3.zzc || !zzif.zza(zzie4.zzb, zzie3.zzb) || !zzif.zza(zzie4.zza, zzie3.zza);
        if (z && this.zza != null) {
            z2 = true;
        }
        if (z3) {
            Bundle bundle3 = bundle2 != null ? new Bundle(bundle2) : new Bundle();
            zzlb.zzK(zzie3, bundle3, true);
            if (zzie4 != null) {
            ...
            if (zzie3.zze) {
                ...
                if (j6 != 0) {
                    j2 = j6;
                    this.zzt.zzq().zzH(str4, "_vs", j2, bundle3);
                }
            } else {
                j3 = currentTimeMillis;
            }
    ...
    /* access modifiers changed from: private */
    public final void zzB(zzie zzie, boolean z, long j) {
        this.zzt.zzd().zzf(this.zzt.zzav().elapsedRealtime());
        if (this.zzt.zzu().zzb.zzd(zzie != null && zzie.zzd, z, j) && zzie != null) {
            zzie.zzd = false;
        }
    }

    static /* bridge */ /* synthetic */ void zzp(zzim zzim, Bundle bundle, zzie zzie, zzie zzie2, long j) {
        bundle.remove(FirebaseAnalytics.Param.SCREEN_NAME);
        bundle.remove(FirebaseAnalytics.Param.SCREEN_CLASS);
        zzim.zzA(zzie, zzie2, j, true, zzim.zzt.zzv().zzy((String) null, FirebaseAnalytics.Event.SCREEN_VIEW, bundle, (List) null, false));
    }
    ...
    private final zzie zzy(Activity activity) {
        ...
        return this.zzg != null ? this.zzg : zzie;
    }

    private final void zzz(Activity activity, zzie zzie, boolean z) {
        zzie zzie2;
        zzie zzie3;
        if (this.zzb == null) {
            zzie2 = this.zzc;
        ...
        zzie zzie4 = zzie2;
        if (zzie.zzb == null) {
            zzie3 = new zzie(zzie.zza, activity != null ? zzl(activity.getClass(), "Activity") : null, zzie.zzc, zzie.zze, zzie.zzf);
        } else {
            zzie3 = zzie;
        }
        this.zzc = this.zzb;
        this.zzb = zzie3;
        this.zzt.zzaz().zzp(new zzih(this, zzie3, zzie4, this.zzt.zzav().elapsedRealtime(), z));
    }
    ...
    public final zzie zzj(boolean z) {
        ...
        zzie zzie = this.zza;
        return zzie != null ? zzie : this.zzh;
    }
    ...
    public final void zzv(Activity activity, Bundle bundle) {
        ...
        if (this.zzt.zzf().zzu() && bundle != null && (zzie = (zzie) this.zzd.get(activity)) != null) {
            ...
            bundle2.putString(AppMeasurementSdk.ConditionalUserProperty.NAME, zzie.zza);
    ...
    public final void zzw(android.app.Activity r4, java.lang.String r5, java.lang.String r6) {
        /*
            ...
            com.google.android.gms.measurement.internal.zzef r3 = r3.zzl()
    ...
    public final void zzx(android.os.Bundle r13, long r14) {
        /*
            ...
            com.google.android.gms.measurement.internal.zzfr r12 = r12.zzt     // Catch:{ all -> 0x011b }
            com.google.android.gms.measurement.internal.zzeh r12 = r12.zzay()     // Catch:{ all -> 0x011b }
            com.google.android.gms.measurement.internal.zzef r12 = r12.zzl()     // Catch:{ all -> 0x011b }
            java.lang.String r13 = "Cannot log screen view event when the app is in the background."
            r12.zza(r13)     // Catch:{ all -> 0x011b }
        ...
        L_0x0033:
            ...
            com.google.android.gms.measurement.internal.zzeh r12 = r12.zzay()     // Catch:{ all -> 0x011b }
            com.google.android.gms.measurement.internal.zzef r12 = r12.zzl()     // Catch:{ all -> 0x011b }
            java.lang.String r13 = "Invalid screen name length for screen view. Length"
            int r14 = r3.length()     // Catch:{ all -> 0x011b }
            java.lang.Integer r14 = java.lang.Integer.valueOf(r14)     // Catch:{ all -> 0x011b }
            r12.zzb(r13, r14)     // Catch:{ all -> 0x011b }
            monitor-exit(r0)     // Catch:{ all -> 0x011b }
            return
        L_0x004c:
        ...
        L_0x0065:
            ...
            com.google.android.gms.measurement.internal.zzeh r12 = r12.zzay()     // Catch:{ all -> 0x011b }
            com.google.android.gms.measurement.internal.zzef r12 = r12.zzl()     // Catch:{ all -> 0x011b }
            java.lang.String r13 = "Invalid screen class length for screen view. Length"
            int r14 = r2.length()     // Catch:{ all -> 0x011b }
            java.lang.Integer r14 = java.lang.Integer.valueOf(r14)     // Catch:{ all -> 0x011b }
            r12.zzb(r13, r14)     // Catch:{ all -> 0x011b }
            monitor-exit(r0)     // Catch:{ all -> 0x011b }
            return
        ...
        L_0x0094:
            ...
            com.google.android.gms.measurement.internal.zzeh r12 = r12.zzay()     // Catch:{ all -> 0x011b }
            com.google.android.gms.measurement.internal.zzef r12 = r12.zzl()     // Catch:{ all -> 0x011b }
            java.lang.String r13 = "Ignoring call to log screen view event with duplicate parameters."
            r12.zza(r13)     // Catch:{ all -> 0x011b }
            monitor-exit(r0)     // Catch:{ all -> 0x011b }
            return
        L_0x00c0:
