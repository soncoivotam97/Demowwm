...
public final class MaterialColorUtilitiesHelper {
    ...
    public static Map<Integer, Integer> createColorResourcesIdsToColorValues(DynamicScheme dynamicScheme) {
        HashMap hashMap = new HashMap();
        for (Map.Entry next : colorResourceIdToColorValue.entrySet()) {
            hashMap.put((Integer) next.getKey(), Integer.valueOf(((DynamicColor) next.getValue()).getArgb(dynamicScheme)));
        }
