...
public final class Utils {
    ...
    public static <T> Task<T> race(Executor executor, Task<T> task, Task<T> task2) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        Utils$$ExternalSyntheticLambda2 utils$$ExternalSyntheticLambda2 = new Utils$$ExternalSyntheticLambda2(taskCompletionSource);
        task.continueWith(executor, utils$$ExternalSyntheticLambda2);
        task2.continueWith(executor, utils$$ExternalSyntheticLambda2);
        return taskCompletionSource.getTask();
    }
