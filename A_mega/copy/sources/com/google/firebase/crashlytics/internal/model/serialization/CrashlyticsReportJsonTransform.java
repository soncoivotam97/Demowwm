        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    builder.setEvents(parseArray(jsonReader, new CrashlyticsReportJsonTransform$$ExternalSyntheticLambda2()));
                    break;
                case 5:
    ...
    private static CrashlyticsReport.FilesPayload parseNdkPayload(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (nextName.equals("files")) {
                builder.setFiles(parseArray(jsonReader, new CrashlyticsReportJsonTransform$$ExternalSyntheticLambda5()));
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    builder.setInternalKeys(parseArray(jsonReader, new CrashlyticsReportJsonTransform$$ExternalSyntheticLambda1()));
                    break;
                case 3:
                    builder.setCustomAttributes(parseArray(jsonReader, new CrashlyticsReportJsonTransform$$ExternalSyntheticLambda1()));
                    break;
                case 4:
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    ...
                    break;
                case 1:
                    builder.setThreads(parseArray(jsonReader, new CrashlyticsReportJsonTransform$$ExternalSyntheticLambda3()));
                    break;
                case 2:
                    builder.setSignal(parseEventSignal(jsonReader));
                    break;
                case 3:
                    builder.setBinaries(parseArray(jsonReader, new CrashlyticsReportJsonTransform$$ExternalSyntheticLambda4()));
                    break;
                case 4:
