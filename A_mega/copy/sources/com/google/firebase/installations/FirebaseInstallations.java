...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    FirebaseInstallations(FirebaseApp firebaseApp2, Provider<HeartBeatController> provider) {
        this(new ThreadPoolExecutor(0, 1, KEEP_ALIVE_TIME_IN_SECONDS, TimeUnit.SECONDS, new LinkedBlockingQueue(), THREAD_FACTORY), firebaseApp2, new FirebaseInstallationServiceClient(firebaseApp2.getApplicationContext(), provider), new PersistedInstallation(firebaseApp2), Utils.getInstance(), new Lazy(new FirebaseInstallations$$ExternalSyntheticLambda3(firebaseApp2)), new RandomFidGenerator());
    }
    ...
    FirebaseInstallations(ExecutorService executorService, FirebaseApp firebaseApp2, FirebaseInstallationServiceClient firebaseInstallationServiceClient, PersistedInstallation persistedInstallation2, Utils utils2, Lazy<IidStore> lazy, RandomFidGenerator randomFidGenerator) {
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new FirebaseInstallations$$ExternalSyntheticLambda1(this));
        return addGetIdListener;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$getId$1$com-google-firebase-installations-FirebaseInstallations  reason: not valid java name */
    public /* synthetic */ void m177lambda$getId$1$comgooglefirebaseinstallationsFirebaseInstallations() {
        m178lambda$getToken$2$comgooglefirebaseinstallationsFirebaseInstallations(false);
    }
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new FirebaseInstallations$$ExternalSyntheticLambda2(this));
    }
    ...
    public final void m178lambda$getToken$2$comgooglefirebaseinstallationsFirebaseInstallations(boolean z) {
    ...
    public void m176lambda$doRegistrationOrRefresh$3$comgooglefirebaseinstallationsFirebaseInstallations(boolean r3) {
        /*
            r2 = this;
        ...
        L_0x005f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.m176lambda$doRegistrationOrRefresh$3$comgooglefirebaseinstallationsFirebaseInstallations(boolean):void");
    }
