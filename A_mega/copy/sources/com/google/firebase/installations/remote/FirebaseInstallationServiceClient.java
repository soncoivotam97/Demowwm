...
public class FirebaseInstallationServiceClient {
    ...
    private static String availableFirebaseOptions(String str, String str2, String str3) {
        return String.format("Firebase options used while communicating with Firebase server APIs: %s, %s%s", new Object[]{str2, str3, TextUtils.isEmpty(str) ? "" : ", " + str});
    }
    ...
    private static java.lang.String readErrorResponse(java.net.HttpURLConnection r5) {
        ...
        L_0x0008:
            ...
            r3.<init>(r0, r4)
            r2.<init>(r3)
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
            r0.<init>()     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
        L_0x0019:
            java.lang.String r3 = r2.readLine()     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
            if (r3 == 0) goto L_0x0029
            java.lang.StringBuilder r3 = r0.append(r3)     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
            r4 = 10
            r3.append(r4)     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
            goto L_0x0019
        L_0x0029:
            java.lang.String r3 = "Error when communicating with the Firebase Installations server API. HTTP response: [%d %s: %s]"
            int r4 = r5.getResponseCode()     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
            java.lang.Integer r4 = java.lang.Integer.valueOf(r4)     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
            java.lang.String r5 = r5.getResponseMessage()     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
            java.lang.Object[] r5 = new java.lang.Object[]{r4, r5, r0}     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
            java.lang.String r5 = java.lang.String.format(r3, r5)     // Catch:{ IOException -> 0x0048, all -> 0x0043 }
