...
public final class DurationKt {
    ...
    private static final long m1657timesmvk6XK0(int i, long j) {
        return Duration.m1569timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final long m1656timeskIfJnKk(double d, long j) {
        return Duration.m1568timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        if (length != 0) {
            long r82 = Duration.Companion.m1633getZEROUwyO8pc();
            ...
            if (length > i3) {
                ...
                if (str2.charAt(i3) == 'P') {
                                ...
                                if (charSequence.length() != 0) {
                                    ...
                                    if (durationUnit2 == null || durationUnit2.compareTo(durationUnitByIsoChar) > 0) {
                                        ...
                                        if (durationUnitByIsoChar != DurationUnit.SECONDS || indexOf$default <= 0) {
                                            z4 = z7;
                                            r82 = Duration.m1567plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                                        } else {
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring2 = substring.substring(0, indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring2, "this as java.lang.String…ing(startIndex, endIndex)");
                                            z4 = z7;
                                            long r0 = Duration.m1567plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring3 = substring.substring(indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                                            r82 = Duration.m1567plusLRDsOJo(r0, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                                        }
                                        z7 = z4;
                    ...
                    if (!z) {
                        ...
                        String str6 = str3;
                        if (StringsKt.regionMatches(str, i3, "Infinity", 0, Math.max(i6 - i3, "Infinity".length()), true)) {
                            r82 = Duration.Companion.m1631getINFINITEUwyO8pc();
                        } else {
                            boolean z8 = !z5;
                                ...
                                if (charSequence3.length() != 0) {
                                    ...
                                    if (durationUnit == null || durationUnit.compareTo(durationUnitByShortName) > 0) {
                                        ...
                                        if (indexOf$default2 > 0) {
                                            ...
                                            long r5 = Duration.m1567plusLRDsOJo(r82, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                                            Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                                            String substring7 = substring4.substring(indexOf$default2);
                                            Intrinsics.checkNotNullExpressionValue(substring7, str5);
                                            r8 = Duration.m1567plusLRDsOJo(r5, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                                            if (i3 < i) {
                                                throw new IllegalArgumentException("Fractional component must be last");
                                            }
                                        } else {
                                            r8 = Duration.m1567plusLRDsOJo(r82, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                                        }
                                        str2 = str;
                                        str4 = str7;
                ...
                if (z2) {
                    return Duration.m1583unaryMinusUwyO8pc(r82);
                }
                return r82;
            }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1531constructorimpl(j << 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1531constructorimpl((j << 1) + 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1531constructorimpl((j << 1) + ((long) i));
    }
