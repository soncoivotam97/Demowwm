...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m1414getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public final long m1438getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1439getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) ((j3 >>> 32) ^ j3)) + (((((int) ULong.m373constructorimpl(j ^ ULong.m373constructorimpl(j >>> 32))) * 31) + ((int) ULong.m373constructorimpl(j2 ^ ULong.m373constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(ULong.m419toStringimpl(this.first)).append("..").append(ULong.m419toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder().append(ULong.m419toStringimpl(this.first)).append(" downTo ").append(ULong.m419toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1440fromClosedRange7ftBX0g(long j, long j2, long j3) {
