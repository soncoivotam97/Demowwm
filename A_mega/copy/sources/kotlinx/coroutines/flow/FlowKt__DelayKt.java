...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1750debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1704toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m1751sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1704toDelayMillisLRDsOJo(j));
    }
}
