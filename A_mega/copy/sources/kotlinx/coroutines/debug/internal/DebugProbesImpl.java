...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m199constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
            ...
            obj = Result.m199constructorimpl(ResultKt.createFailure(th));
        }
    }
    ...
    public final java.lang.String hierarchyToString(kotlinx.coroutines.Job r9) {
        ...
        L_0x001c:
            ...
            r8.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r3 = INSTANCE     // Catch:{ all -> 0x00c8 }
            boolean r4 = r3.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x00c8 }
            if (r4 == 0) goto L_0x00bc
            java.util.Set r3 = r3.getCapturedCoroutines()     // Catch:{ all -> 0x00c8 }
            java.lang.Iterable r3 = (java.lang.Iterable) r3     // Catch:{ all -> 0x00c8 }
            java.util.ArrayList r4 = new java.util.ArrayList     // Catch:{ all -> 0x00c8 }
            r4.<init>()     // Catch:{ all -> 0x00c8 }
            java.util.Collection r4 = (java.util.Collection) r4     // Catch:{ all -> 0x00c8 }
        ...
        L_0x003c:
            ...
            r6 = r5
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r6 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r6     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.Continuation<T> r6 = r6.delegate     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.CoroutineContext r6 = r6.getContext()     // Catch:{ all -> 0x00c8 }
            kotlinx.coroutines.Job$Key r7 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.CoroutineContext$Key r7 = (kotlin.coroutines.CoroutineContext.Key) r7     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.CoroutineContext$Element r6 = r6.get(r7)     // Catch:{ all -> 0x00c8 }
            if (r6 == 0) goto L_0x003c
            r4.add(r5)     // Catch:{ all -> 0x00c8 }
            goto L_0x003c
        L_0x005d:
            java.util.List r4 = (java.util.List) r4     // Catch:{ all -> 0x00c8 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x00c8 }
            r3 = 10
            int r3 = kotlin.collections.CollectionsKt.collectionSizeOrDefault(r4, r3)     // Catch:{ all -> 0x00c8 }
            int r3 = kotlin.collections.MapsKt.mapCapacity(r3)     // Catch:{ all -> 0x00c8 }
            r5 = 16
            int r3 = kotlin.ranges.RangesKt.coerceAtLeast((int) r3, (int) r5)     // Catch:{ all -> 0x00c8 }
            java.util.LinkedHashMap r5 = new java.util.LinkedHashMap     // Catch:{ all -> 0x00c8 }
            r5.<init>(r3)     // Catch:{ all -> 0x00c8 }
            java.util.Map r5 = (java.util.Map) r5     // Catch:{ all -> 0x00c8 }
            java.util.Iterator r3 = r4.iterator()     // Catch:{ all -> 0x00c8 }
        L_0x007c:
            boolean r4 = r3.hasNext()     // Catch:{ all -> 0x00c8 }
            if (r4 == 0) goto L_0x009b
            java.lang.Object r4 = r3.next()     // Catch:{ all -> 0x00c8 }
            r6 = r4
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r6 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r6     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.Continuation<T> r6 = r6.delegate     // Catch:{ all -> 0x00c8 }
            kotlin.coroutines.CoroutineContext r6 = r6.getContext()     // Catch:{ all -> 0x00c8 }
            kotlinx.coroutines.Job r6 = kotlinx.coroutines.JobKt.getJob(r6)     // Catch:{ all -> 0x00c8 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r4 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r4     // Catch:{ all -> 0x00c8 }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r4 = r4.info     // Catch:{ all -> 0x00c8 }
            r5.put(r6, r4)     // Catch:{ all -> 0x00c8 }
            goto L_0x007c
        L_0x009b:
            ...
            java.lang.String r6 = ""
            r4.build(r9, r5, r3, r6)     // Catch:{ all -> 0x00c8 }
            java.lang.String r9 = r3.toString()     // Catch:{ all -> 0x00c8 }
            java.lang.String r3 = "StringBuilder().apply(builderAction).toString()"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r9, r3)     // Catch:{ all -> 0x00c8 }
        L_0x00b0:
        ...
        L_0x00bc:
            ...
            java.lang.IllegalStateException r3 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00c8 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x00c8 }
            r3.<init>(r9)     // Catch:{ all -> 0x00c8 }
    ...
    public final java.lang.Object[] dumpCoroutinesInfoAsJsonAndReferences() {
        ...
        L_0x00c6:
            ...
            r1 = 0
            java.lang.Thread[] r4 = new java.lang.Thread[r1]
            java.lang.Object[] r2 = r2.toArray(r4)
            java.lang.String r4 = "null cannot be cast to non-null type kotlin.Array<T of kotlin.collections.ArraysKt__ArraysJVMKt.toTypedArray>"
            if (r2 == 0) goto L_0x011d
            java.util.Collection r3 = (java.util.Collection) r3
            kotlin.coroutines.jvm.internal.CoroutineStackFrame[] r5 = new kotlin.coroutines.jvm.internal.CoroutineStackFrame[r1]
            java.lang.Object[] r3 = r3.toArray(r5)
            if (r3 == 0) goto L_0x0117
            java.util.Collection r0 = (java.util.Collection) r0
            kotlinx.coroutines.debug.internal.DebugCoroutineInfo[] r1 = new kotlinx.coroutines.debug.internal.DebugCoroutineInfo[r1]
            java.lang.Object[] r0 = r0.toArray(r1)
            if (r0 == 0) goto L_0x0111
            java.lang.Object[] r14 = new java.lang.Object[]{r14, r2, r3, r0}
            return r14
        L_0x0111:
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String str, Thread thread, List<StackTraceElement> list) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            DebugProbesImpl debugProbesImpl = this;
            obj = Result.m199constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m199constructorimpl(ResultKt.createFailure(th));
        }
