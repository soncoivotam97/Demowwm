...
public final class ImmLeaksCleaner implements LifecycleEventObserver {
    ...
    public void onStateChanged(androidx.lifecycle.LifecycleOwner r2, androidx.lifecycle.Lifecycle.Event r3) {
        ...
        L_0x000f:
            ...
            androidx.activity.ImmLeaksCleaner$Companion r2 = Companion
            androidx.activity.ImmLeaksCleaner$Cleaner r2 = r2.getCleaner()
            java.lang.Object r3 = r2.getLock(r1)
            if (r3 != 0) goto L_0x002b
            return
        L_0x002b:
            monitor-enter(r3)
            android.view.View r0 = r2.getServedView(r1)     // Catch:{ all -> 0x0047 }
        ...
        L_0x0034:
            ...
            return
        L_0x003c:
            boolean r2 = r2.clearNextServedView(r1)     // Catch:{ all -> 0x0047 }
            monitor-exit(r3)
