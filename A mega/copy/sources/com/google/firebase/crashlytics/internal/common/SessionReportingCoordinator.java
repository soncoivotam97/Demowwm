...
public class SessionReportingCoordinator implements CrashlyticsLifecycleEvents {
    ...
    public Task<Void> sendReports(Executor executor, String str) {
        ...
        for (CrashlyticsReportWithSessionId next : loadFinalizedReports) {
            if (str == null || str.equals(next.getSessionId())) {
                arrayList.add(this.reportsSender.enqueueReport(next, str != null).continueWith(executor, new SessionReportingCoordinator$$ExternalSyntheticLambda1(this)));
            }
        }
    ...
    private void persistEvent(Throwable th, Thread thread, String str, String str2, long j, boolean z) {
        ...
        CrashlyticsReport.Session.Event addLogsAndCustomKeysToEvent = addLogsAndCustomKeysToEvent(captureEventData);
        String str3 = str;
        crashlyticsReportPersistence.persistEvent(addLogsAndCustomKeysToEvent, str, equals);
    }
