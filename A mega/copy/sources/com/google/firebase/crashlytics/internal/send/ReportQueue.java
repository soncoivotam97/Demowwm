...
final class ReportQueue {
    ...
    public /* synthetic */ void m172lambda$flushScheduledReportsIfAble$0$comgooglefirebasecrashlyticsinternalsendReportQueue(CountDownLatch countDownLatch) {
    ...
    public void sendReport(CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, TaskCompletionSource<CrashlyticsReportWithSessionId> taskCompletionSource) {
        ...
        this.transport.schedule(Event.ofUrgent(crashlyticsReportWithSessionId.getReport()), new ReportQueue$$ExternalSyntheticLambda1(this, taskCompletionSource, crashlyticsReportWithSessionId));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$sendReport$1$com-google-firebase-crashlytics-internal-send-ReportQueue  reason: not valid java name */
    public /* synthetic */ void m173lambda$sendReport$1$comgooglefirebasecrashlyticsinternalsendReportQueue(TaskCompletionSource taskCompletionSource, CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, Exception exc) {
        if (exc != null) {
