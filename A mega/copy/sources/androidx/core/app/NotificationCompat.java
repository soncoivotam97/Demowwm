    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r12, int r13, boolean r14) {
            ...
            L_0x0157:
                ...
                androidx.core.app.NotificationCompat.Style.Api24Impl.setChronometerCountDown(r7, r14, r11)
                goto L_0x01b0
            L_0x019c:
            ...
            L_0x01af:
                r13 = r10
            L_0x01b0:
                int r11 = androidx.core.R.id.right_side
            ...
            L_0x01b7:
                ...
                int r11 = androidx.core.R.id.line3
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            for (Message androidMessage : this.mMessages) {
                Notification.MessagingStyle messagingStyle = createMessagingStyle;
                Api24Impl.addMessage(createMessagingStyle, androidMessage.toAndroidMessage());
            }
            for (Message androidMessage2 : this.mHistoricMessages) {
                Notification.MessagingStyle messagingStyle2 = createMessagingStyle;
                Api26Impl.addHistoricMessage(createMessagingStyle, androidMessage2.toAndroidMessage());
            }
            this.mIsGroupConversation.booleanValue();
            Notification.MessagingStyle messagingStyle3 = createMessagingStyle;
            Api24Impl.setConversationTitle(createMessagingStyle, this.mConversationTitle);
            Notification.MessagingStyle messagingStyle4 = createMessagingStyle;
        ...
        public static final class Message {
            ...
            public Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                Notification.MessagingStyle.Message createMessage = Api28Impl.createMessage(text, timestamp, person);
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            if (remoteInput2 != null) {
                remoteInput = new RemoteInput(Api20Impl.getResultKey(remoteInput2), Api20Impl.getLabel(remoteInput2), Api20Impl.getChoices(remoteInput2), Api20Impl.getAllowFreeFormInput(remoteInput2), Api29Impl.getEditChoicesBeforeSending(remoteInput2), Api20Impl.getExtras(remoteInput2), (Set<String>) null);
            }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i = 0; i < remoteInputs.length; i++) {
                ...
                remoteInputArr2[i] = new RemoteInput(Api20Impl.getResultKey(remoteInput), Api20Impl.getLabel(remoteInput), Api20Impl.getChoices(remoteInput), Api20Impl.getAllowFreeFormInput(remoteInput), Api29Impl.getEditChoicesBeforeSending(remoteInput), Api20Impl.getExtras(remoteInput), (Set<String>) null);
            }
        ...
        if (Api23Impl.getIcon(action) == null && action2.icon != 0) {
            return new Action(action2.icon, action2.title, action2.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z3, isContextual, z4);
        }
        if (Api23Impl.getIcon(action) != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action));
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z3, isContextual, z4);
    }
