...
public final class UStringsKt {
    ...
    public static final String m1503toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1505toStringolVBNx4(short s, int i) {
    ...
    public static final String m1504toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1502toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m267unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m530unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m346unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m425unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m346unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m294constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m211boximpl(UByte.m217constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m346unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m294constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m474boximpl(UShort.m480constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m294constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m294constructorimpl(i3 * r3);
            int r7 = UInt.m294constructorimpl(UInt.m294constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m373constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m373constructorimpl(j * r5);
            long r13 = ULong.m373constructorimpl(ULong.m373constructorimpl(((long) UInt.m294constructorimpl(digitOf)) & 4294967295L) + r9);
