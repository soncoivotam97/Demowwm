...
public final class UMathKt {
    ...
    private static final int m1418minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1400minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1419mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1408minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1416maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1388maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1417maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1396maxOfeb3DHEI(j, j2);
    }
}
