    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m199constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m199constructorimpl(Unit.INSTANCE);
        if (Result.m206isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1737successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1735closedJP2dKIU(Result.m202exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1722boximpl(obj3);
    }
}
