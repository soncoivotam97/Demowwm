...
public final class DelayKt {
    ...
    public static final Object m1703delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1704toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1704toDelayMillisLRDsOJo(long j) {
        if (Duration.m1530compareToLRDsOJo(j, Duration.Companion.m1633getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1549getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
